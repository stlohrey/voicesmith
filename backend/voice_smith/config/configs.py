...
class PreprocessingConfig:
    ...
    use_audio_normalization: bool = False
    workers: int = 11
    stft: STFTConfig = field(default_factory=lambda: STFTConfig(
        filter_length=1024,
        hop_length=256,
        win_length=1024,
        n_mel_channels=100,
...
class AcousticENModelConfig:
    ...
    encoder: ConformerConfig = field(default_factory= lambda : ConformerConfig(
        n_layers=4,
        n_heads=6,
        n_hidden=384,
        p_dropout=0.1,
    ...
    decoder: ConformerConfig = field(default_factory= lambda :ConformerConfig(
        n_layers=6,
        n_heads=6,
        n_hidden=384,
        p_dropout=0.1,
    ...
    reference_encoder: ReferenceEncoderConfig = field(default_factory= lambda :ReferenceEncoderConfig(
        bottleneck_size_p=4,
    ...
    variance_adaptor: VarianceAdaptorConfig = field(default_factory= lambda :VarianceAdaptorConfig(
...
class VocoderModelConfig:
    gen: VocoderGeneratorConfig = field(default_factory= lambda : VocoderGeneratorConfig(
        noise_dim=64,
        channel_size=32,
        dilations=[1, 3, 9, 27],
        strides=[8, 8, 4],
    ...
    mpd: VocoderMPDConfig = field(default_factory= lambda : VocoderMPDConfig(
        periods=[2, 3, 5, 7, 11],
        kernel_size=5,
        stride=3,
    ...
    mrd: VocoderMRDConfig = field(default_factory= lambda : VocoderMRDConfig(
